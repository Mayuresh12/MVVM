...
class ProfileHeader: UICollectionReusableView {
    ...
    addSubview(profileImageView)
        ...
        let stack = UIStackView(arrangedSubviews: [postLabel,follwersLabel,followingLabel])
        ...
        bottomStack.anchor(left: leftAnchor,
                           bottom: bottomAnchor,
                           right: rightAnchor,
                           height: 50)
        
        topDivider.anchor(left: leftAnchor,
                           bottom: bottomAnchor,
                           right: rightAnchor,
                           height: 0.5)
        
        bottomDivider.anchor(left: leftAnchor,
                           bottom: bottomAnchor,
                           right: rightAnchor,
                           height: 0.5)
